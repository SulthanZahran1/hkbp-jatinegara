...
{{-- <div id="loader" class="center"></div> <!-- loading page --> --}}
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Data Ruas / Data Keluarga</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                  ...
                  <div class="row" style="height: 70px;">
                    <div class="col-12">
                      ...
                      <button type="button" id="addKeluarga" class="btn btn-primary float-right" style="margin-right:0px; margin-top:-40px" onclick=keluarga()>
                       + Tambah Keluarga
                      </button>
                    </div>
                  </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align: left;">
                        <dl>
                          <dt><a href="" data-toggle="modal" data-target="#detail-pribadi">Nama Anggota dan Marga 1</a></dt>
                          <dt><a href="" data-toggle="modal" data-target="#detail-pribadi">Nama Anggota dan Marga 2</a></dt>
                          <dt><a href="" data-toggle="modal" data-target="#detail-pribadi">Nama Anggota dan Marga 3</a></dt>
                        </dl>
                      </td>
                      <td style="text-align: left;">3</td>
                      <td>
                          <a class="btn btn-primary btn-sm" id ="view_{{ $i }}" href="#" data-toggle="modal" data-target="#view-dataKeluarga">
                            <i class="fas fa-search">
                            </i>
                            View
                         </a>
                          <a class="btn btn-info btn-sm" id ="edit_{{ $i }}" href="#" data-toggle="modal" data-target="#edit-dataKeluarga">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Edit
                          </a>
                          <a class="btn btn-danger btn-sm" id ="delete_{{ $i }}" href="#" data-toggle="modal" data-target="#hapus-dataKeluarga">
  ...
  <!-- /.content-wrapper -->
     ...
     <!-- MODAL UNTUK VIEW KELUARGA -->
     <div class="modal fade" id="view-dataKeluarga">
  ...
  <!-- END OF MODAL VIEW KELUARGA -->
        ...
        <div class="modal fade" id="detail-pribadi">
...
<script>
  ...
  function keluarga(){
    let url = '{{ url('/dataruas/inputdatakeluarga') }}';
