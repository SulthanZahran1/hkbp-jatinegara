        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Data Induk / Sintua</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                  ...
                  <div class="row" style="height: 70px;">
                    <div class="col-12">
                      ...
                      <button type="button" data-toggle="modal" data-target="#tambah-sintua" class="btn btn-primary float-right" style="margin-right:0px; margin-top:-40px">
                       + Tambah Sintua
                      </button>
                    </div>
                  </div>
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{ $i }}</td>
                      <td style="text-align: left;">St. NAMA MARGA</td>
                      <td style="text-align: left;">ABCD</td>
                      <td style="text-align: left;">SEKTOR</td>
                      <td style="text-align: left;">0812XXXXXXX</td>
                      <td>
                          ...
                          <a class="btn btn-danger btn-sm" id ="delete_{{ $i }}" href="#" data-toggle="modal" data-target="#hapus-sintua">
